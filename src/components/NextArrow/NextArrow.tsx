...
const NextArrow = (props: any) => {
    const { onClick } = props; // Define onClick here as a prop for use in div below
    return (
        <div
            onClick={onClick}
...
export default NextArrow; // Export the arrow for import into slick-slider(NewArrivals.tsx)